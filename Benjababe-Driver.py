...
class Map():
    ...
    def add_wumpus(self, X: int, Y: int):
        ...
        self.set_adjacent_element(X, Y, "stench", "on")

    def remove_wumpus(self):
        X, Y = self.wumpus_pos
        cell = self.cells[Y][X]
        cell.elements["wumpus"] = "off"
        self.set_adjacent_element(X, Y, "stench", "off")
        self.wumpus_pos = []

    def add_portal(self, X: int, Y: int):
        cell = self.cells[Y][X]
        cell.elements["portal"] = "on"
        self.set_adjacent_element(X, Y, "tingle", "on")
    ...
    def set_adjacent_element(self, X: int, Y: int, element: str, status: str):
        self.cells[Y-1][X].elements[element] = status
        self.cells[Y][X-1].elements[element] = status
        self.cells[Y][X+1].elements[element] = status
        self.cells[Y+1][X].elements[element] = status
